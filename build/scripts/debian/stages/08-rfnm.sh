#!/bin/sh
# Stage 8 — rfnm
# Installs the RFNM LA9310 kernel driver modules, FreeRTOS firmware, and the
# rfnm rootfs overlay into the final rootfs.
# Requires LA9310 driver + RTOS to have been built first.
set -e
...
RFNM_OVERLAY="$(cd "$SCRIPT_DIR/.." && pwd)/rootfs-overlay/rfnm"
